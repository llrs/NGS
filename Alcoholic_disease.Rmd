...
```{r contrasts}
contrasts0 <- makeContrasts("ASHvsNormal" = ASH - Normal,
...
par(mfrow = c(1, 3))
qqt(fit2.2$t[, "Progression"], df = fit2.2$df.total, main = "Student's t Q-Q Plot of Progression")
abline(0, 1)
...
```{r venn, fig.width = 30, fig.height = 15}
vennDiagram(results[, c(1:3, 6)], cex = c(1, 1, 0.7), 
            circle.col = c("red", "green", "black", "blue"), 
            main = "Genes shared in the progression of the disease")
```
...
```{r venn2, fig.width = 30, fig.height = 30}
par(mfrow = c(3, 3))
vennDiagram(results[, c(1, 2)],  cex = c(1, 1, 0.7), 
            circle.col = c("red", "green", "black", "blue"), 
            main = "DEG shared in the progression of the disease")
vennDiagram(results[, c(1, 2)],  cex = c(1, 1, 0.7), include = "up", 
            circle.col = c("red", "green", "black", "blue"), 
            main = "Genes Up-regulated shared")
vennDiagram(results[, c(1, 2)],  cex = c(1, 1, 0.7), include = "down", 
            circle.col = c("red", "green", "black", "blue"), 
            main = "Genes Down-regulated")

vennDiagram(results[, c(2, 3)],  cex = c(1, 1, 0.7), 
            circle.col = c("red", "green", "black", "blue"), 
            main = "DEG shared in the progression of the disease")
vennDiagram(results[, c(2, 3)],  cex = c(1, 1, 0.7), include = "up", 
            circle.col = c("red", "green", "black", "blue"), 
            main = "Genes Up-regulated shared")
vennDiagram(results[, c(2, 3)],  cex = c(1, 1, 0.7), include = "down", 
            circle.col = c("red", "green", "black", "blue"), 
            main = "Genes Down-regulated")

vennDiagram(results[, c(3, 6)],  cex = c(1, 1, 0.7), 
            circle.col = c("red", "green", "black", "blue"), 
            main = "DEG shared in the progression of the disease")
vennDiagram(results[, c(3, 6)],  cex = c(1, 1, 0.7), include = "up", 
            circle.col = c("red", "green", "black", "blue"), 
            main = "Genes Up-regulated shared")
vennDiagram(results[, c(3, 6)],  cex = c(1, 1, 0.7), include = "down", 
            circle.col = c("red", "green", "black", "blue"), 
            main = "Genes Down-regulated")
```
